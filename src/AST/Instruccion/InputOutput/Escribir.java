...
public class Escribir implements Instruccion
{
    ...
    public String cadenaAImprimir="";
    public boolean salto = false;
    
    public Escribir(Expresion v, int l, int c)
    {
        this.valor = v;
        this.linea = l;
        this.columna = c;
    ...
    public Escribir(Expresion v, int l, int c, ArrayList<Expresion> list )
    {
        this.valor = v;
        this.linea = l;
        this.columna = c;
    ...
    public Escribir(Expresion v, boolean s, int l, int c)
    {
        this.valor = v;
        this.linea = l;
        this.columna = c;
    ...
    public void Imprimir(Entorno e, String c)
    {
        if(salto)
        {
            Utilidades.Singlenton.writeLinea(c,linea,columna);
